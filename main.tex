...
\descript{| QUANT DEVELOPER }
\runsubsection{}
\descript{TECH STACK - PYTHON, kdb+, q}
\location{July 2018 – Present | Bengaluru}
\vspace{\topsep} % Hacky fix for awkward extra vertical space

\location{ Risk Analytic Dashboard | Team size : 1}
\begin{tightemize}
...
\location{July 2017 – July 2018 | Bengaluru}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
